...
CREATE TABLE IF NOT EXISTS Marina_Quotations (
    ...
    marina_mooring_rates_id INT NOT NULL,
    arrival_date DATE,
    departure_date DATE,
    arrival_status BOOLEAN, 
    days_stay INT NOT NULL, 
    discount_stay FLOAT(12,6),
    tax FLOAT(12,6),
    total FLOAT(12,6), 
    subtotal FLOAT(12,6)
);
...
CREATE TABLE IF NOT EXISTS Marina_Payments_Relations (
    ...
    marina_payment_relation_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS Marina_Payments (
    ...
    currency VARCHAR(10),
    currency_date DATE,
    payment_received FLOAT(12,6),
    converted_amount FLOAT(12,6),
    creation_date DATE
);
